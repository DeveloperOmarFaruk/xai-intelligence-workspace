    ...
    <>
      ...
      <div className="flex items-center justify-between border-b border-border/70 bg-background/80 backdrop-blur-md p-4 lg:hidden sticky top-0 z-40 w-full">
        ...
        <button
          ...
          className="p-2 rounded-xl hover:bg-surface text-foreground transition-colors cursor-pointer"
      ...
      >
        <div>
          ...
          <div className="flex items-center justify-between border-b border-border/60 pb-6">
            ...
            <button
              onClick={toggleSidebar}
              className="lg:hidden p-2 rounded-xl hover:bg-surface text-muted-foreground cursor-pointer hover:text-foreground"
            >
              <X className="h-5 w-5" />
            </button>
          </div>
